const Seo = (props) => {
  const {
    ...
    description = 'Regala y regálate experiencias, planes y momentos que te dejen grandes recuerdos. Con Tienda Experiencias los tienes todos en un solo lugar. Conócelos ahora.',
